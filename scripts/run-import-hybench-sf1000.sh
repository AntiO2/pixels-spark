...
if [[ $# -ge 2 ]]; then
  ...
  TARGET_ROOT="$(pixels_get_property pixels.import.hybench.sf1000.hudi.target-root s3a://home-zinuo/hudi/hybench_sf1000)"
else
  TARGET_ROOT="$(pixels_get_property pixels.import.hybench.sf1000.target-root s3a://home-zinuo/deltalake/hybench_sf1000)"
fi
