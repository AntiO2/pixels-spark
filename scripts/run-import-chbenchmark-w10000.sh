...
CSV_ROOT="${1:-$(pixels_get_property pixels.import.chbenchmark.w10000.csv-root /home/ubuntu/disk1/ch_w10000)}"
if [[ $# -ge 2 ]]; then
  TARGET_ROOT="$2"
elif [[ "$IMPORT_MODE" == "hudi" ]]; then
  TARGET_ROOT="$(pixels_get_property pixels.import.chbenchmark.w10000.hudi.target-root s3a://home-zinuo/hudi/chbenchmark_w10000)"
else
  TARGET_ROOT="$(pixels_get_property pixels.import.chbenchmark.w10000.target-root s3a://home-zinuo/deltalake/chbenchmark_w10000)"
fi
LOG_DIR="${LOG_DIR:-$(pixels_get_property pixels.import.chbenchmark.w10000.log-dir /home/ubuntu/disk1/tmp/chbenchmark_w10000_import_logs)}"
STATE_DIR="${STATE_DIR:-$(pixels_get_property pixels.import.chbenchmark.w10000.state-dir /home/ubuntu/disk1/tmp/chbenchmark_w10000_import_state)}"
