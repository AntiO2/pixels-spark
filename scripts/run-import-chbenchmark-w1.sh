...
if [[ $# -ge 2 ]]; then
  ...
  TARGET_ROOT="$(pixels_get_property pixels.import.chbenchmark.w1.hudi.target-root s3a://home-zinuo/hudi/chbenchmark_w1)"
else
  TARGET_ROOT="$(pixels_get_property pixels.import.chbenchmark.w1.target-root s3a://home-zinuo/deltalake/chBench_wh1)"
fi
