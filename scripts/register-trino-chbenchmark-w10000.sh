...
CATALOG="${1:-$(pixels_get_property pixels.trino.chbenchmark.w10000.catalog delta_lake)}"
SCHEMA="${2:-$(pixels_get_property pixels.trino.chbenchmark.w10000.schema chbenchmark_w10000)}"
TARGET_ROOT="${3:-$(pixels_get_property pixels.trino.chbenchmark.w10000.target-root s3://home-zinuo/deltalake/chbenchmark_w10000)}"
TABLES=()
