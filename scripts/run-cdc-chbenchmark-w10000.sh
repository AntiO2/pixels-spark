...
CKPT_ROOT="${CKPT_ROOT:-$(pixels_get_property pixels.cdc.chbenchmark.${PROFILE}.checkpoint-root /home/ubuntu/disk1/tmp/chbenchmark_w10000_cdc_ckpt)}"
METRICS_DIR="${METRICS_DIR:-$(pixels_get_property pixels.cdc.chbenchmark.${PROFILE}.metrics-dir /home/ubuntu/disk1/tmp/chbenchmark_w10000_cdc_metrics)}"
RESOURCE_DIR="${RESOURCE_DIR:-$(pixels_get_property pixels.cdc.chbenchmark.${PROFILE}.resource-dir ${ROOT_DIR}/data/chbenchmark/w10000/resource)}"
SPARK_EVENTS_DIR="${SPARK_EVENTS_DIR:-$(pixels_get_property pixels.spark.event-log.dir /home/ubuntu/disk1/tmp/spark-events)}"
TARGET_ROOT="${TARGET_ROOT:-$(pixels_get_property pixels.cdc.chbenchmark.${PROFILE}.target-root "$(pixels_get_property pixels.import.chbenchmark.${PROFILE}.target-root s3a://home-zinuo/deltalake/chbenchmark_w10000)")}"
